...
interface AdjustLevelsProps {
  width?: number | string;
  height?: number | string;
  strokeColor?: string;
}

export const AdjustLevels: React.FC<AdjustLevelsProps> = ({ width = 40, height = 40, strokeColor = 'black'}) => {


  return (
<svg height={height} width={width} version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" enable-background="new 0 0 512 512">
  <g>
    <g fill={strokeColor}>
